...
SELECT * FROM s3(s3_conn, filename='03036_archive*.tar.gz :: example*.csv') ORDER BY id;
SELECT * FROM s3(s3_conn, filename='03036_archive*.tar* :: example{2..3}.csv') ORDER BY id;
